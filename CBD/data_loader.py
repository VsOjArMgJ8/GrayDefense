...
def get_train_loader(opt):
    ...
    if (opt.dataset == 'CIFAR10'):
        trainset = datasets.CIFAR10(root='/home/xfLee/Datasets/CIFAR10', train=True, download=True)
    else:
...
def get_test_loader(opt):
    ...
    if (opt.dataset == 'CIFAR10'):
        testset = datasets.CIFAR10(root='/home/xfLee/Datasets/CIFAR10', train=False, download=True)
...
def get_backdoor_loader(opt):
    ...
    if (opt.dataset == 'CIFAR10'):
        ...
        if opt.trigger_type == 'dynamic':
            trainset = datasets.CIFAR10(root='/home/xfLee/Datasets/CIFAR10', train=True, download=True, transform=transform)
        else:
            trainset = datasets.CIFAR10(root='/home/xfLee/Datasets/CIFAR10', train=True, download=True)
    elif (opt.dataset == 'gtsrb'):
        if opt.trigger_type == 'dynamic':
